package com.ugdacc.modul89_d_10830_project2
...
import com.ugdacc.modul89_d_10830_project2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun createNotificationChannel(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            val name = "UGD89_D_10830_PROJECT2"
    ...
    private fun sendNotification2(){
        val builder = NotificationCompat.Builder(this, CHANNEL_ID_2)
            ...
            .setContentTitle("MODUL89_D_10830_PROJECT2")
